...
TEXTUP_AUTH_URL = _env_str("TEXTUP_AUTH_URL", "https://api-auth.textup.uz/v1/login")
TEXTUP_SMS_URL = _env_str("TEXTUP_SMS_URL", "https://sms-api.textup.uz/v1/send")
TEXTUP_EMAIL = _env_str("TEXTUP_EMAIL", "")
TEXTUP_PASSWORD = _env_str("TEXTUP_PASSWORD", "")
TEXTUP_SMS_TEMPLATE = _env_str(
    "TEXTUP_SMS_TEMPLATE",
    "Metan Servis tizimiga kirish kodi: {code}",
)
TEXTUP_TIMEOUT_SECONDS = _env_int("TEXTUP_TIMEOUT_SECONDS", 15)
TEXTUP_TOKEN_TTL_SECONDS = _env_int("TEXTUP_TOKEN_TTL_SECONDS", 55 * 60)
TEXTUP_DEBUG_RESPONSE = _env_bool("TEXTUP_DEBUG_RESPONSE", False)
SMS_LOGIN_OTP_TTL_SECONDS = _env_int("SMS_LOGIN_OTP_TTL_SECONDS", 2 * 60)
SMS_LOGIN_RESEND_SECONDS = _env_int("SMS_LOGIN_RESEND_SECONDS", 60)
SMS_LOGIN_RATE_WINDOW_SECONDS = _env_int("SMS_LOGIN_RATE_WINDOW_SECONDS", 10 * 60)
SMS_LOGIN_MAX_SENDS = _env_int("SMS_LOGIN_MAX_SENDS", 5)
SMS_LOGIN_MAX_ATTEMPTS = _env_int("SMS_LOGIN_MAX_ATTEMPTS", 5)
...
ICAN_CREDIT_LIST_PATH = os.getenv("ICAN_CREDIT_LIST_PATH", "/external/ican/credit").strip()
...
ICAN_CREDIT_COMPANY_ID = _env_int("ICAN_CREDIT_COMPANY_ID", 2075)
ICAN_CREDIT_EMPLOYEE_ID = _env_int("ICAN_CREDIT_EMPLOYEE_ID", 567924)
ICAN_CREDIT_DEFAULT_PAYMENT_DAY = 1
...
NASIYA_BOZOR_API_URL = _env_str(
    "NASIYA_BOZOR_API_URL",
    "https://nasiya-bozor.uz/api/v1",
).rstrip("/")
NASIYA_BOZOR_API_KEY = _env_str(
    "ONLINE_SHOP_API_KEY",
    _env_str("NASIYA_BOZOR_API_KEY", ""),
)
NASIYA_BOZOR_SHOP_ID = _env_str(
    "NASIYA_BOZOR_SHOP_ID",
    _env_str("ONLINE_SHOP_ID", ""),
)
NASIYA_BOZOR_CONNECT_TIMEOUT = _env_float("NASIYA_BOZOR_CONNECT_TIMEOUT", 10)
NASIYA_BOZOR_READ_TIMEOUT = _env_float("NASIYA_BOZOR_READ_TIMEOUT", 30)
